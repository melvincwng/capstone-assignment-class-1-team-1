...
export const ABOUT_US_DATA = [{
  ...
  frontCardTextOne: "Kua is a software developer & the team member for this Full-stack Capstone Project (FCP). He is responsible to team-work with the team-leader and another team member and implement a feature that gets the movie sorted in Z to A ",
  frontCardTextTwo: "👉 Hover over the card to find out more",
  backCardTextOne: "Additional Details:",
