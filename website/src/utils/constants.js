...
export const ABOUT_US_DATA = [
  {
    ...
    backCardTextTwoArray: [
      "Set up the main code repository for the team to work on",
      "Implemented this full-stack web app basic features",
      "Implemented numerous advanced/additional features",
      "Handled the cloud deployment for both FE & BE apps",
      "Involved in QA testing, fixed bugs, added documentation, reviewed incoming PRs & provided technical support to the team",
    ],
  ...
  },
  {
    ...
    backCardTextOne: "Additional Details:",
    backCardTextTwoArray: [
      "Implement the feature that gets the movie sorted in A to Z",
